...
import { textAnimation, myFotoAnimation } from "../../components/Animations/Animations.tsx";
  ...
  return (
    ...
    >
      ...
      <div className={classes.contactPageContent}>
        <motion.img custom={5} variants={myFotoAnimation} className={classes.contactPageMyFace} src='https://firebasestorage.googleapis.com/v0/b/calendar-react-85cff.appspot.com/o/commonImages%2F20241008_155429_0_0_0_0-removebg.png?alt=media&token=bdcc6b4e-b62c-4f84-b3a3-c2a4211f5938'/>
      </div>
